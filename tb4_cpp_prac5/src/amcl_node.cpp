...
namespace iar_amcl
{
  ...
  AmclNode::createLaserObject()
  {
    ...
    RCLCPP_INFO(get_logger(), "it is IAR_AMCL likelihood field Model");

    return new iar_amcl::LikelihoodFieldModel(
        z_hit_, z_max_, z_rand_, sigma_hit_, laser_likelihood_max_dist_, max_beams_, map_);
  }
